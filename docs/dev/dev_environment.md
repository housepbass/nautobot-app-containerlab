...
- `nautobot_ver`: the version of Nautobot to use as a base for any built docker containers (default: 2.2.0)
- `project_name`: the default docker compose project name (default: `containerlab`)
...
#14 naming to docker.io/containerlab/nautobot:2.2.0-py3.11 done
```
...
Creating network "containerlab_default" with the default driver
Creating volume "containerlab_postgres_data" with default driver
Creating containerlab_redis_1 ...
Creating containerlab_docs_1  ...
Creating containerlab_postgres_1 ...
Creating containerlab_postgres_1 ... done
Creating containerlab_redis_1    ... done
Creating containerlab_nautobot_1 ...
Creating containerlab_docs_1     ... done
Creating containerlab_nautobot_1 ... done
Creating containerlab_worker_1   ...
Creating containerlab_worker_1   ... done
...
ee90fbfabd77   containerlab/nautobot:2.2.0-py3.11  "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               containerlab_worker_1
b8adb781d013   containerlab/nautobot:2.2.0-py3.11  "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   containerlab_nautobot_1
d64ebd60675d   containerlab/nautobot:2.2.0-py3.11  "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   containerlab_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   containerlab_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   containerlab_redis_1
```
...
Stopping containerlab_worker_1   ...
Stopping containerlab_nautobot_1 ...
Stopping containerlab_docs_1     ...
Stopping containerlab_redis_1    ...
Stopping containerlab_postgres_1 ...
Stopping containerlab_worker_1   ... done
Stopping containerlab_nautobot_1 ... done
Stopping containerlab_postgres_1 ... done
Stopping containerlab_redis_1    ... done
Stopping containerlab_docs_1     ... done
Removing containerlab_worker_1   ...
Removing containerlab_nautobot_1 ...
Removing containerlab_docs_1     ...
Removing containerlab_redis_1    ...
Removing containerlab_postgres_1 ...
Removing containerlab_postgres_1 ... done
Removing containerlab_docs_1     ... done
Removing containerlab_worker_1   ... done
Removing containerlab_redis_1    ... done
Removing containerlab_nautobot_1 ... done
Removing network containerlab_default
```
...
So for example, our app is named `containerlab`, the command would most likely be `docker logs containerlab_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("containerlab")
namespace.configure(
    {
        "containerlab": {
            ...
...
Or set the `INVOKE_CONTAINERLAB_PYTHON_VER` variable.
...
Or set the `INVOKE_CONTAINERLAB_NAUTOBOT_VER` variable.
...
In the package source, there is the `containerlab/app-config-schema.json` file, conforming to the [JSON Schema](https://json-schema.org/) format. This file is used to validate the configuration of the app in CI pipelines.
